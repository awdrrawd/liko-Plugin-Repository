...
// AUTO-GENERATED from src/pcm/loader-local-entry.js by scripts/build-pcm.mjs. Do not edit directly.
(() => {
  // src/pcm/config.js
  ...
  // src/pcm/loader-local-entry.js
  startLoader({ localBase: "http://localhost:5175/" });
})();
