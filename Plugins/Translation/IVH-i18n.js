...
(function () {
    ...
    const IVH_STRINGS = {
        ...
        'enabledDesc': {
            ...
            JP: '有効にすると没入感が高まり、不快に感じる可能性のある効果（強い点滅、画面破砕、振動など）も含まれます。ご自身の状態に合わせてご利用ください。',
            KR: '활성화하면 몰입감이 높아지며, 불편할 수 있는 효과(강한 깜빡임, 화면 깨짐, 진동 등)도 포함됩니다. 본인 상태에 맞게 사용하세요.',
        ...
        'climaxOnOrgasm': { TW: '僅高潮時', CN: '仅高潮时', EN: 'On orgasm', JP: '絶頂時のみ', KR: '절정 시에만', DE: 'Bei Orgasmus', FR: 'À l\'orgasme', RU: 'При оргазме', UA: 'При оргазмі' },
        'climaxAlways':   { TW: '每次觸發', CN: '每次触发', EN: 'Every time', JP: '毎回', KR: '매번', DE: 'Jedes Mal', FR: 'À chaque fois', RU: 'Каждый раз', UA: 'Щоразу' },
        ...
        'about_assets': { TW: '── 使用素材皆為免費素材 ──', CN: '── 使用素材皆为免费素材 ──', EN: '── All assets are free assets ──', JP: '── 使用素材はすべて無料素材です ──', KR: '── 사용된 모든 소재는 무료 소재입니다 ──', DE: '── Alle Materialien sind kostenlos ──', FR: '── Tous les éléments sont gratuits ──', RU: '── Все материалы — бесплатные ──', UA: '── Усі матеріали — безкоштовні ──' },
        ...
        'fx_figblurD':{ TW: '畫面模糊但人物/人影保持清晰', CN: '画面模糊但人物/人影保持清晰', EN: 'Screen blurs while figure/ghost stay sharp', JP: '画面はぼけるがキャラ／人影は鮮明なまま', KR: '화면은 흐려지지만 캐릭터/그림자는 선명', DE: 'Bild unscharf, Figur/Schemen bleiben scharf', FR: 'Écran flou, perso/ombre nets', RU: 'Экран размыт, фигура/тень чёткие', UA: 'Екран розмитий, фігура/тінь чіткі' },
        ...
        'ev_dualSound':  { TW: '雙重音效', CN: '双重音效', EN: 'Dual Sound', JP: 'デュアル音声', KR: '이중 사운드', DE: 'Doppelton', FR: 'Double son', RU: 'Двойной звук', UA: 'Подвійний звук' },
        'ev_dualSoundD': { TW: '播放說話聲的同時，疊放一個觸發音（鐘擺等，使用「催眠」分類音效）。', CN: '播放说话声的同时，叠放一个触发音（钟摆等，使用「催眠」分类音效）。', EN: 'Layer a trigger sound (pendulum, etc., from the Hypno category) over the voice.', JP: '話し声と同時にトリガー音（振り子など「催眠」カテゴリ）を重ねる。', KR: '말소리와 동시에 트리거 음(시계추 등 「최면」 카테고리)을 겹침.', DE: 'Einen Auslöseton (Pendel usw. aus „Hypno") über die Stimme legen.', FR: 'Superpose un son déclencheur (pendule, etc., catégorie « Hypno ») à la voix.', RU: 'Накладывает звук-триггер (маятник и т.п. из «Гипно») поверх голоса.', UA: 'Накладає звук-тригер (маятник тощо з «Гіпно») поверх голосу.' },
        ...
        'sndCat_voice':  { TW: '催眠2', CN: '催眠2', EN: 'Hypno2', JP: '催眠2', KR: '최면2', DE: 'Hypno2', FR: 'Hypno2', RU: 'Гипно2', UA: 'Гіпно2' },
