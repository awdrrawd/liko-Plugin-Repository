...
(function () {
    ...
    const _strings = {
        ...
        'refreshTitle':      { TW: '即刻更新', CN: '立即更新', DE: 'Aktualisieren', FR: 'Actualiser', RU: 'Обновить', UA: 'Оновити' },
        'refreshing':        { TW: '正在抓取最新插件清單...', CN: '正在抓取最新插件清单...', DE: 'Neueste Liste wird abgerufen...', FR: 'Récupération de la dernière liste...', RU: 'Получение последнего списка...', UA: 'Отримання останнього списку...' },
        'refreshDone':       { TW: '插件清單已更新！', CN: '插件清单已更新！', DE: 'Plugin-Liste aktualisiert!', FR: 'Liste des plugins mise à jour !', RU: 'Список плагинов обновлён!', UA: 'Список плагінів оновлено!' },
