...
<b style='color:#87CEEB;'>/mat settings</b> — Відкрити сторінку налаштувань
        ...
        'dFoldRecv': { TW: "收到訊息並翻譯成功後，把原句與譯文合併成一組；展開時譯文在上、原文在下，點訊息前方的「A/文」按鈕可展開/收合原句。翻譯失敗或簡繁跳過時不摺疊。", CN: "收到消息并翻译成功后，把原句与译文合并成一组；展开时译文在上、原文在下，点消息前方的「A/文」按钮可展开/折叠原句。翻译失败或简繁跳过时不折叠。", EN: "After translating a received message, group the original and translation; when expanded, the translation is above the original. Click \"A/文\" to show/hide the original. Not folded if translation fails or is zh-skipped." },
        'dFoldSend': { TW: "你發送的訊息翻譯廣播回顯後，把原句與譯文合併成一組（僅自己畫面）；展開時譯文在上、原文在下，點「A/文」可展開/收合原句。需搭配「僅發送譯文」關閉才有原句可摺。", CN: "你发送的消息翻译广播回显后，把原句与译文合并成一组（仅自己画面）；展开时译文在上、原文在下，点「A/文」可展开/折叠原句。需关闭「仅发送译文」才有原句可折。", EN: "After your translation broadcast echoes back, group it with your original (your view only); when expanded, the translation is above the original. Click \"A/文\" to show/hide it. Requires \"Send translation only\" to be OFF." },
