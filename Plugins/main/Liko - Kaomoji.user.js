        ...
        const DEFAULT_GROUPS = [
            ...
            },
            {
                id: "g_shy", name: "害羞", emotes: [
                    ...
                    "((٩(//̀Д/́/)۶))", "( ˶´︎‬ω`˵ )", "( ˶´︎‬ч`˵ )", "๑˃̶͈̀Ⱉ˂̶͈́๑", "( ˶¯꒳¯˵)", "꒰ᐢ˶•༝•˵ᐢ꒱",
            ...
            },
            {
                id: 'g_cry', name: '難過', emotes: [
                    '（ᵒ̴̶̷̥́ ·̫ ᵒ̴̶̷̣̥̀）', '˃̣̣̥᷄⌓˂̣̣̥᷅', '༼ಢ_ಢ༽', '(⁠༎ຶ⁠ ⁠෴⁠ ⁠༎ຶ⁠)', '(⁠´⁠°̥̥̥̥⁠ω⁠°̥̥̥̥⁠｀⁠)', '╮(╯_╰)╭',
                    '( ´•︵•` )', '(｡ŏ_ŏ)', '(☍﹏⁰)', 'థ౪థ', 'ㅍㅅㅍ', '꒰˚ ˃̣̣̥⌓˂̣̣̥ ꒱',
                    '｡ﾟ', '꒰ ﾟஇ‸இﾟ꒱｡ﾟ', '(⋟﹏⋞)', 'ಥ⁠_⁠ಥ', '▄█▀█●', 'ฅ(๑ ̀ㅅ ́๑)ฅ',
            ...
            },
            {
                id: 'g_animals', name: '動物', emotes: [
                    ...
                    '૮ ˆﻌˆ ა', 'ʕ⁠ ⁠ꈍ⁠ᴥ⁠ꈍ⁠ʔ', 'ʕ•ᴥ•ʔ', 'ʕ ᵔᴥᵔ ʔ', 'ʕ•̫͡•ʔ*̫͡*ʔ-̫͡-ʔ', '꒰\'ꀾ\'꒱',
                    'ʕ⸝⸝⸝˙Ⱉ˙ʔ', 'ʕ•ﻌ•ʔ', 'ᖰ•ᴥ•ᖳ', 'ʕ◍·̀Ⱉ·́◍ʔ', 'ʕ•ɷ•ʔ', 'ʕ´•ᴥ•`ʔ',
                    '(ᵒꈊᵒ᷅ )', '(՞•Ꙫ•՞)', '(⁰⊖⁰)', '₍ᐢ.ˬ.ᐢ₎', 'εїз', 'Ƹ̵Ӝ̵Ʒ',
                    '⋛⋋( ‘Θ’)⋌⋚', 'く⁠コ⁠:⁠彡', '̑̑ᗦ↞◃', '(:◎)≡', '˚ʚ₍ᐢ.  ̫.ᐢ₎ɞ˚', '₍ᐢ.ˬ.ᐢ₎',
